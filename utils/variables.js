export const challengeThemes = [
    ...
    { id: 93, name: 'TOEIC 900レベル', imageFilename: 'TOEIC900.png', activeStatus: 'PREPARING' },
    { id: 93, name: 'TOEIC 800レベル', imageFilename: 'TOEIC800.png', activeStatus: 'PREPARING' },
    { id: 93, name: 'TOEIC 700レベル', imageFilename: 'TOEIC700.png', activeStatus: 'PREPARING' },
    { id: 93, name: 'TOEIC 600レベル', imageFilename: 'TOEIC600.png', activeStatus: 'PREPARING' },
  ];
